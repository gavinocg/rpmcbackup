...
public class MainForm : Form
{
    ...
    private void CreateTrayIcon()
    {
        ...
        _trayMenu.Items.Add("Abrir Configuración", null, (s, e) => { ShowInTaskbar = true; Show(); WindowState = FormWindowState.Normal; });
        _trayMenu.Items.Add("Sincronizar ahora", null, (s, e) => { SendIpc(Constants.CmdSyncNow); });
        _trayMenu.Items.Add("Detener servicio", null, (s, e) => { if (PromptAdminPassword("Detener servicio")) SendIpc(Constants.CmdStop); });
        ...
        _trayIcon.DoubleClick += (s, e) => { ShowInTaskbar = true; Show(); WindowState = FormWindowState.Normal; };
    ...
    private void SetTrayIcon(ServiceStatus status)
    {
        ...
        {
            ServiceStatus.Running => StatusHelper.IconGreen,
            ServiceStatus.Error => StatusHelper.IconRed,
            ServiceStatus.Stopped => StatusHelper.IconRed,
            _ => StatusHelper.IconGray
        };
    }
    ...
    private void UpdateStatusUI(ServiceStateInfo state)
    {
        ...
        try
        {
            ...
            _statusIndicator.BackColor = info.FormColor;
